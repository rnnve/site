export default function SiteFooter() {
	...
	return (
		<footer className="mt-auto flex min-w-0 flex-row flex-wrap items-center justify-between gap-1 border-t border-outline-variant/70 pt-3 pb-2 text-xs text-outline">
