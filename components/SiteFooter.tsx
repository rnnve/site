export default function SiteFooter() {
	...
	return (
		<footer className="mt-auto flex min-w-0 flex-col items-center justify-between gap-1 border-t border-ctp-surface1/70 pt-3 text-xs text-ctp-overlay0 min-[28rem]:flex-row min-[28rem]:gap-4">
